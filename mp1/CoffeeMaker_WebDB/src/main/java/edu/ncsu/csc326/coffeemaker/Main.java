...
public class Main {
    ...
    public static void deleteRecipe() {
        ...
        String recipeDeleted = coffeeMaker.deleteRecipe(recipes[recipeToDelete-1].getName());
    ...
    public static void editRecipe() {
	    ...
	    try {
			...
			String recipeEdited = coffeeMaker.editRecipe(recipes[recipeToEdit-1].getName(), newRecipe);
