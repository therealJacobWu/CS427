...
<%
	...
	if (price != null && !"null".equals(value)) {
		...
		if (cm.getRecipes()[recipeNum] != null) {
		    ...
		    int P_price = cm.getRecipes()[recipeNum].getPrice();
			int P_amtCoffee = cm.getRecipes()[recipeNum].getAmtCoffee();
			int P_amtMilk = cm.getRecipes()[recipeNum].getAmtMilk();
			int P_amtSugar = cm.getRecipes()[recipeNum].getAmtSugar();
			int P_amtChocolate = cm.getRecipes()[recipeNum].getAmtChocolate();
%>
<form method="post" action="edit_recipe.jsp">
<table>
<tr>
<td><input type="text" name="price" value ="<%= P_price%>"></td><td><span class="font1">Recipe Price (integer)</span></td>
</tr>
<tr>
<td><input type="text" name="amtCoffee" value ="<%= P_amtCoffee%>"></td><td><span class="font1">Units Coffee</span></td>
</tr>
<tr>
<td><input type="text" name="amtMilk" value ="<%= P_amtMilk%>"></td><td><span class="font1">Units Milk</span></td>
</tr>
<tr>
<td><input type="text" name="amtSugar" value ="<%= P_amtSugar%>"></td><td><span class="font1">Units Sugar</span></td>
</tr>
<tr>
<td><input type="text" name="amtChocolate" value ="<%= P_amtChocolate%>"></td><td><span class="font1">Units Chocolate</span></td>
</tr>
</table>
