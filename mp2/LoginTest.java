...
public class LoginTest extends iTrustSeleniumTest {
	...
	public void testResetPassword() throws Exception{
		...
		new Select(wd.findElement(By.name("role"))).selectByVisibleText("Patient");
        WebElement element  = wd.findElement(By.name("mid"));
        element.clear();
        element.sendKeys("1");
		element.submit();
        ...
        WebElement element1 = wd.findElement(By.name("confirmPassword"));
        element1.sendKeys("newPw12345");
        element1.submit();
